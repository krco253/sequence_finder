...
FLAGS = -isystem /home/kcole/devel/seqan/include -std=c++14 -O3 -DNDEBUG -W -Wall -pedantic -fopenmp -lpthread -pthread -ggdb -Wno-unused-parameter -Wno-sequence-point #flags necessary to use Seqan and its particular implementation in this source code
